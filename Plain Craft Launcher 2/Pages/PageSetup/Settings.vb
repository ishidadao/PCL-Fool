...
Public Class Settings
    ...
    Public Shared ReadOnly Entries As Dictionary(Of String, Setting) = (New List(Of Setting) From {
        ...
        New Setting("LaunchTargetMode", 0, Source:=Sources.Registry),
        New Setting("LaunchServerLast", "", Source:=Sources.Registry),
        New Setting("LaunchServerHistory", "", Source:=Sources.Registry),
        New Setting("LaunchServerManagedAddresses", "", Source:=Sources.Registry),
